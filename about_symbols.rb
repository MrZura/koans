...
class AboutSymbols < Neo::Koan
  ...
  # Если будем сравнивать с символом, то мы создадим символ, если он не существовал, и он
  # внесется в общий список, затем сравнение выдаст нам true, в любом случае.
  ...
  # Создавая много символов, мы засоряем много памяти, которую не
  # получится освободить до конца работы приложения.
end
